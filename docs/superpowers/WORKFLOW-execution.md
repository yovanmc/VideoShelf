...
| 2 — App shell + browse | `feat/app-shell` | — | [ ] Not started | Write plan first. Adds App project + App.Tests, WPF shell, library browse, thumbnails, search, sort, unwatched badges, missing-file marking. |
...
| 4 — Discovery + tags | `feat/discovery` | — | [ ] Not started | Continue-watching + recency rails, For-you / pick-a-tag / more-from-section, section tagging. |
